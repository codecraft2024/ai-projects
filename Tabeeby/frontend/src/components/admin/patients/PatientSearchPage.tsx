...
import { PatientCardActions } from "@/components/admin/patients/PatientCardActions";
            ...
            <div className="space-y-3 md:hidden">
              {patients.length === 0 ? (
                ...
                patients.map((patient) => (
                  <PatientMobileCard key={patient.id} patient={patient} t={t} />
                ))
              )}
            </div>
                  ...
                  {patients.length === 0 ? (
                    ...
                    patients.map((patient) => (
                      ...
                      >
                        ...
                        <td className="min-w-[14rem] px-4 py-3 sm:pr-0">
                          <PatientCardActions patientId={patient.id} layout="row" />
                        </td>
                      </tr>
                    ))
                  )}
