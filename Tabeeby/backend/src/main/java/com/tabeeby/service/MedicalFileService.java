...
import com.tabeeby.dto.MedicalFileResponse;
import com.tabeeby.exception.ResourceNotFoundException;
import com.tabeeby.model.MedicalFile;
import com.tabeeby.model.MedicalFileType;
import com.tabeeby.model.Patient;
import com.tabeeby.repository.MedicalFileRepository;
import com.tabeeby.repository.PatientRepository;
...
public class MedicalFileService {
    ...
    private void validateFile(MultipartFile file) {
        ...
        throw new IllegalArgumentException(
                "Unsupported file type. Use JPEG, PNG, PDF, Word, or HEIC (max 25 MB).");
    }
